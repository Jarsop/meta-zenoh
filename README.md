...
Currently, `master` branch of the layer is tested with `master` branch (`blacksail`) of the Yocto Project.

`wrynose` and `walnascar` branches are available to build on the matching Yocto releases.
